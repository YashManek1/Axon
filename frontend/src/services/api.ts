...
export const authAPI = {
  ...
  register: (data: { username: string; email: string; password: string; orgName: string; orgDescription?: string }) =>
...
export const jobsAPI = {
  ...
  update: (id: string, data: Record<string, unknown>) => api.put("/jobs/updateJob/" + id, data),
